...
namespace SW1_ISO9126_FUZZY.ModelosVistas {
    ...
    internal class ModeloHamburgerMenu : ModeloVistaBase {
        ...
        public ModeloHamburgerMenu() {
			...
			this.Menu.Add(new MenuItem() { Icon = new Uri("/Imagenes/report.png", UriKind.RelativeOrAbsolute), NavigationDestination = new Uri("Vistas/ReporteCalidadPage.xaml", UriKind.RelativeOrAbsolute) });
